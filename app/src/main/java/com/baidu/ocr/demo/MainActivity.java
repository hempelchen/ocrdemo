...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int REQUEST_CODE_FACERECOGNIZE = 120;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.face_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(intent, REQUEST_CODE_FACERECOGNIZE);
            }
        });
    ...
    private void initAccessTokenWithAkSk() {
        ...
        }, getApplicationContext(), "1tRCmZAuXH81rGWPe0OEddrn", "u6Ln0NRKKCzMBfsIWCkFNn2KPCGl4LK9");
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_FACERECOGNIZE && resultCode == Activity.RESULT_OK) {
            RecognizeService.recFace(FileUtil.getSaveFile(getApplicationContext()).getAbsolutePath(),
                    new RecognizeService.ServiceListener() {
                        @Override
                        public void onResult(String result) {
                            infoPopText(result);
