...
public class MaskView extends View {
    ...
    public static final int MASK_TYPE_FACE_FRONT = 21;

    @IntDef({MASK_TYPE_NONE, MASK_TYPE_ID_CARD_FRONT, MASK_TYPE_ID_CARD_BACK, MASK_TYPE_BANK_CARD, MASK_TYPE_FACE_FRONT})
    @interface MaskType {
    ...
    public void setMaskType(@MaskType int maskType) {
        ...
        switch (maskType) {
            ...
            case MASK_TYPE_ID_CARD_BACK:
                ...
                break;
            case MASK_TYPE_FACE_FRONT:
                locatorDrawable = ResourcesCompat.getDrawable(getResources(),
                        R.drawable.bd_face_locator_front, null);
                break;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        } else if (maskType == MASK_TYPE_FACE_FRONT) {
            locatorDrawable.setBounds(
                    (int) (left + 231f / 1006 * width),
                    (int) (top + (50f / 632) * height),
                    (int) (left + (774f / 1006) * width),
                    (int) (top + (599f / 632) * height));
