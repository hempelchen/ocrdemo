...
public class CameraActivity extends Activity {
    ...
    public static final String CONTENT_TYPE_FACE_RECGNOIZE = "faceRecognize";
    ...
    private OCRCameraLayout confirmResultContainerFace;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirmResultContainerFace = (OCRCameraLayout) findViewById(R.id.confirm_result_container_face);
        ...
        confirmResultContainerFace.findViewById(R.id.confirm_button).setOnClickListener(confirmButtonOnClickListener);
        confirmResultContainerFace.findViewById(R.id.cancel_button).setOnClickListener(confirmCancelButtonOnClickListener);
    ...
    private void initParams() {
        ...
        switch (contentType) {
            ...
            case CONTENT_TYPE_BANK_CARD:
                ...
                overlayView.setVisibility(View.INVISIBLE);
                break;
            case CONTENT_TYPE_FACE_RECGNOIZE:
                maskType = MaskView.MASK_TYPE_FACE_FRONT;
                overlayView.setVisibility(View.INVISIBLE);
                break;
    ...
    private void showCrop() {
        ...
        confirmResultContainer.setVisibility(View.INVISIBLE);
        confirmResultContainerFace.setVisibility(View.INVISIBLE);
    ...
    private void showResultConfirmFace() {
        cameraView.getCameraControl().pause();
        updateFlashMode();
        takePictureContainer.setVisibility(View.INVISIBLE);
        confirmResultContainer.setVisibility(View.INVISIBLE);
        confirmResultContainerFace.setVisibility(View.VISIBLE);
        cropContainer.setVisibility(View.INVISIBLE);
    }
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (cropMaskView.getMaskType() == MaskView.MASK_TYPE_NONE) {
                        ...
                        showCrop();
                    } else if (cropMaskView.getMaskType() == MaskView.MASK_TYPE_FACE_FRONT) {
                        cropView.setFilePath(outputFile.getAbsolutePath());
                        cropMaskView.setVisibility(View.INVISIBLE);
                        overlayView.setVisibility(View.VISIBLE);
                        overlayView.setTypeWide();
    ...
    private View.OnClickListener cropConfirmButtonListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (maskType) {
                ...
                case MaskView.MASK_TYPE_FACE_FRONT:
    ...
    private void setOrientation(Configuration newConfig) {
        ...
        confirmResultContainerFace.setOrientation(orientation);
    }
